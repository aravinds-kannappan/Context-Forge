...
def main() -> None:
    ...
    bench.add_argument("--models", nargs="+", default=["gpt2", "distilbert-base-uncased", "google/flan-t5-small"])
    bench.add_argument("--strategies", nargs="+", default=["hard_prompt_pruning", "embedding_chunk_drop", "kv_cache_eviction"])
    bench.add_argument("--ratios", nargs="+", type=float, default=[0.35, 0.5, 0.65, 0.8])
    ...
    train.add_argument("--model", default="gpt2")
